...
#define MW_BOARDPARAMETERS_DEVICEADDRESS 192.168.80.51
#define MW_BOARDPARAMETERS_USERNAME ubuntu
#define MW_RUNTIME_BUILDACTION 3
#define MW_ROS2INSTALL_FOLDER /opt/ros/foxy
#define MW_ROS2INSTALL_WORKSPACE ~/turtlebot3_ws
